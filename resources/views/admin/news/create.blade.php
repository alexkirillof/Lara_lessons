...
<div class="row justify-content-center">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label>{{__('adminlang.news_title')}}</label>
        ...
        <div class="form-group">
            <label>{{__('adminlang.news_description')}}</label>
            {!! Form::textarea("description",$model->description ?? old('content') ??"", ['class' => "form-control"]) !!}
        </div>
        <div class="form-group">
            <label>{{__('adminlang.news_category')}}</label>
        ...
        <div class="form-group">
            <label>{{__('adminlang.news_publish_date')}}</label>
            {!! Form::date(
            'publish_date',
